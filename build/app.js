...
const occupationalHealth_1 = tslib_1.__importDefault(require("./routes/occupationalHealth"));
const healthCheck_1 = tslib_1.__importDefault(require("./routes/healthCheck"));
const hospital_1 = tslib_1.__importDefault(require("./routes/hospital"));
...
app.use('/api/occupationalHealth', occupationalHealth_1.default);
app.use('/api/health-check', healthCheck_1.default);
app.use('/api/hospital', hospital_1.default);
